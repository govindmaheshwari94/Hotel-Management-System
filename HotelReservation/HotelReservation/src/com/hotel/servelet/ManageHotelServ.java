...
else if(operation.equals("analytics"))
{
	RequestDispatcher rd=request.getRequestDispatcher("Hotel"); 
       response.sendRedirect(Constants.baseUri+"/Contact");
}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException,IOException
	{
		...
		if(operation.equals("add")){
			...
			String roomCount = request.getParameter("room_count");
			HotelModel.addHotelPrice(hotelId, price, name, roomCount);
			...
			response.sendRedirect(Constants.baseUri+"/ManageHotel?operation=view&error=Hotel deleted succesfully");	
		}
		else if(operation.equals("analytics"))
		{
			response.sendRedirect(Constants.baseUri+"/Contact");
